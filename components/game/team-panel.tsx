...
import { DollarSign, FileText, Users, User, UserCheck, AlertTriangle, ChevronDown } from "lucide-react"
  ...
  return (
    <div className={cn(
      ...
      <button
        ...
        className="w-full text-left p-3.5 hover:bg-secondary/30 transition-colors"
      >
      ...
      {expanded && (
        <>
          ...
          {team.presidentialDecree && (
            <div className="px-3.5 py-2.5 border-t border-border bg-violet-500/5">
          ...
          {team.financialCard && (
            <div className={cn(
              "px-3.5 py-2.5 border-t border-border",
          ...
          {/* Squad list */}
          <div className="overflow-auto p-3 border-t border-border">
