...
const TIER_COLORS = {
  1: { bg: "bg-amber-500/20", border: "border-amber-500/30", text: "text-amber-600 dark:text-amber-400" },
  2: { bg: "bg-slate-400/20", border: "border-slate-400/30", text: "text-slate-600 dark:text-slate-400" },
  3: { bg: "bg-orange-700/20", border: "border-orange-700/30", text: "text-orange-700 dark:text-orange-400" },
}
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-[400px] p-8">
      <div className="text-center mb-6">
        <p className="text-sm text-muted-foreground mb-1">Rodada {state.currentPositionIndex + 1}</p>
        ...
        <div className="flex items-center justify-center gap-1 mt-1">
          ...
          <span className="text-sm text-primary">{managerName}</span>
        </div>
      </div>
